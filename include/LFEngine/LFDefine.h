...
#define LFEFPS_VSYNC		-1
#define LFEFPS_UNLIMITED	0
...
#define BLEND_DEFAULT		(BLEND_COLORMUL | BLEND_ALPHABLEND | BLEND_ZWRITE)
#define BLEND_DEFAULT_NOZ	(BLEND_COLORMUL | BLEND_ALPHABLEND | BLEND_NOZWRITE)
